...
public abstract class ExplorableTreeTableModel extends AbstractTreeTableModel implements Closeable {
	...
	private final DescriptionsDatabase descriptionsDatabase;
	...
	public ExplorableTreeTableModel(Database database, DescriptionsDatabase descriptions) throws ExplorationException {
	...
	public DescriptionsDatabase getDescriptionsDatabase() {
